                                ...
                                <div class="custom_select">
                                    <select id="version_switcher" aria-label="Laravel version">
                                        @foreach ($versions as $key => $display)
                                            <option {{ $currentVersion == $key ? 'selected' : '' }} value="{{ url('lumen-docs/'.$key.$currentSection) }}">{{ $display }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <blockquote>
                                    <div class="callout">
                                        ...
                                        <p class="content">
                                            ...
                                            Consider upgrading your project to <a href="{{ route('lumen.docs.version', DEFAULT_VERSION) }}">Laravel {{ DEFAULT_VERSION }}</a>.
                                        </p>
                                    </div>
                                </blockquote>
                            @endunless
